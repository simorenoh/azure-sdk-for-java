...
public final class ObjectMapperShim {
    ...
    public <T> T deserialize(HttpHeaders headers, Type deserializedHeadersType) throws IOException {
        ...
        T deserializedHeaders = convertValue(headers, deserializedHeadersType);
    ...
    /**
     * Converts object into a give type using serialization.
     *
     * @param fromValue object to be converted.
     * @param toValueType type to convert to.
     * @param <T> type of returned object.
     * @return Converted object.
     * @throws IllegalArgumentException
     */
    private <T> T convertValue(Object fromValue, final Type toValueType) throws IllegalArgumentException {
        try {
            final JavaType javaType = createJavaType(toValueType);
